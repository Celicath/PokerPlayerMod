...
public class PokerPlayerMetricsPatch {
	private static final Logger logger = LogManager.getLogger("PokerPlayerMetrics");
	private static Gson gson = new Gson();
	private static final String URL = "http://52.187.168.135:12507/upload";
	...
	public static class RunPatch {
		...
		public static void Postfix(Metrics __instance, HashMap<Object, Object> ___params) {
			if (AbstractDungeon.player != null && AbstractDungeon.player.chosenClass == ThePokerPlayerEnum.THE_POKER_PLAYER) {
				try {
